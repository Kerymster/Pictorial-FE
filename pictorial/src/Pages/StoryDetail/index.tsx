    ...
    <div className="py-16 bg-gray-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 space-y-8 sm:px-6 lg:px-8">
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-start">
          <div
            id="image"
            className="lg:order-last my-12 relative text-base max-w-prose mx-auto lg:mt-0 lg:max-w-none"
          >
            <svg
          ...
          <div className="lg:order-first relative z-10">
            ...
            <div className="mt-10 flex text-base max-w-prose mx-auto lg:max-w-none">
              <div className="rounded-md shadow">
                <button className="w-full flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">
                  View Image (Fullsize)
                </button>
              </div>
